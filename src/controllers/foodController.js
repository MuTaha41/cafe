...
var foodService_js_1 = require("../services/foodService.js");
var getFoodData = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var errors, foodType, foodCategoryMap, finalFoodData, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, foodService_js_1.generateFoodData)(foodType, foodCategoryMap[foodType])];
            case 2:
                finalFoodData = _a.sent();
                res.status(200).json(finalFoodData);
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                console.error("Error in fetching food data for", foodType, ":", error_1);
